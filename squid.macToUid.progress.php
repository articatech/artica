...
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/squid.macToUid.progress";
$GLOBALS["LOG_FILE"]="/usr/share/artica-postfix/ressources/logs/web/squid.macToUid.progress.txt";
...
function js(){
	...
	$title=$tpl->javascript_parse_text("{proxy_members_aliases}");
	echo "
	YahooWinBrowseHide();		
...
function popup(){
	...
	$sock->getFrameWork("squid.php?MacToUidProgress=yes");
	$t=$_GET["t"];
