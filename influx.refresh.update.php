...
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/influxdb.refresh.progress";
$GLOBALS["LOG_FILE"]="/usr/share/artica-postfix/ressources/logs/web/influxdb.refresh.progress.txt";
...
function popup(){
	...
	$sock->getFrameWork("influx.php?refresh-repos=yes");
	$t=$_GET["t"];
