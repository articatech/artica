...
function js(){
	...
	function postfwd2Start(){
		...
		$('#BodyContent').load('$page?tabs=yes&instance={$_GET["instance"]}&newinterface={$_GET["newinterface"]}');
	}
...
function tabs(){
	...
	while (list ($num, $ligne) = each ($array) ){
		if($num=="objects"){
			$html[]= $tpl->_ENGINE_parse_body("<li><a href=\"postfwd2.objects.php?instance=$instance\"><span style='$fonctsize'>$ligne</span></a></li>\n");
			continue;
		}
		$html[]= $tpl->_ENGINE_parse_body("<li><a href=\"$page?$num=yes&instance=$instance\"><span span style='$fonctsize'>$ligne</span></a></li>\n");
	}
