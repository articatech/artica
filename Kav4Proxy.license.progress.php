...
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/web/kav4license.install.progress";
$GLOBALS["LOG_FILE"]="/usr/share/artica-postfix/ressources/logs/web/kav4license.install.progress.txt";
...
function popup(){
	...
	$sock->getFrameWork("kav4proxy.php?install-key-file=".urlencode($_GET["filename"])."");
	$t=$_GET["t"];
