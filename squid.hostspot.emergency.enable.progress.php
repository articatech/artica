...
function js(){
	...
	$t=time();
	$title=$tpl->javascript_parse_text("{global_urgency_mode}");
...
function popup(){
	...
	$page=CurrentPageName();
	$sock=new sockets();
	$sock->getFrameWork("hotspot.php?emergency-on=yes");
	$t=$_GET["t"];
	if(!is_numeric($t)){$t=time();}
	$text=$tpl->_ENGINE_parse_body("{global_urgency_mode}<br>{please_wait_preparing_settings}...");
