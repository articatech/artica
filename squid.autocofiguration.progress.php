<?php
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/web/squid-autoconf.progress";
...
function title(){
	$tpl=new templates();
	return $tpl->javascript_parse_text("{autoconfiguration_wizard}");
}
...
function Launch(){
	$sock=new sockets();
	$cmd="squid.php?autoconfig-wizard=yes".suffix();
