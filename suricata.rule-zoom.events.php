...
<table class='TABLE_SURICATA_EVENTS_ZOOM' style='display: none' id='TABLE_SURICATA_EVENTS_ZOOM' 
style='width:100%'></table>
<script>
$(document).ready(function(){
	var md5H='';
	$('#TABLE_SURICATA_EVENTS_ZOOM').flexigrid({
...
var xSuricataEnableInterface= function (obj) {
	...
	$('#TABLE_SURICATA_EVENTS_ZOOM').flexReload();
}
