<?php
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/web/squid.newcache.center.progress";
$GLOBALS["CACHEFILE"]=$GLOBALS["PROGRESS_FILE"];
$GLOBALS["LOGSFILES"]="/usr/share/artica-postfix/ressources/logs/web/squid.newcache.center.log";
...
function title(){
	$tpl=new templates();
	return $tpl->javascript_parse_text("{creating_new_cache}");
}
...
function Launch(){
	$sock=new sockets();
	$cmd="squid2.php?create-cache-wizard=yes".suffix();
