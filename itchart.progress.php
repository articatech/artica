...
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/itchart.progress";
$GLOBALS["LOG_FILE"]="/usr/share/artica-postfix/ressources/logs/web/itchart.progress.txt";
...
function js(){
	...
	$title=$tpl->javascript_parse_text("{IT_charter}");
...
function popup(){
	...
	$sock->getFrameWork("squid2.php?itchart-build=yes");
	$t=$_GET["t"];
	if(!is_numeric($t)){$t=time();}
	$text=$tpl->_ENGINE_parse_body("{IT_charter}...");
