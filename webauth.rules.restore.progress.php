...
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/webauth.rules.restore.progress";
$GLOBALS["LOG_FILE"]="/usr/share/artica-postfix/ressources/logs/web/webauth.rules.restore.progress.txt";
...
function js(){
	...
	$title=$tpl->javascript_parse_text("{restore} {$_GET["filename"]}");
	echo "
	YahooWinBrowseHide();		
...
function popup(){
	...
	$sock->getFrameWork("hotspot.php?restore-gz=yes&filename=".urlencode($_GET["filename"])."");
	$t=$_GET["t"];
