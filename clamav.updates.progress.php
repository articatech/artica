...
function js(){
	...
	$title=$tpl->javascript_parse_text("{clamav_antivirus_databases}");
...
function popup(){
	...
	$sock->getFrameWork("clamav.php?freshclam=yes");
	$t=$_GET["t"];
	if(!is_numeric($t)){$t=time();}
	$text=$tpl->_ENGINE_parse_body("{clamav_antivirus_databases}...");
