...
function title(){
	...
	$title=$tpl->_ENGINE_parse_body("{webproxy_statistics_appliance}:{disconnect}");
	return $title;
}
...
function Launch(){
	$sock=new sockets();
	$cmd="artica.php?exec-squid-stats-appliance-disconnect=yes";
