...
$GLOBALS["CACHEFILE"]="/usr/share/artica-postfix/ressources/logs/nmap.pingnet.progress";
...
function title(){
	$tpl=new templates();
	return $tpl->javascript_parse_text("{ping_networks}");
}
