...
if(isset($_GET["group-section"])){groups_section_starter();exit;}	
...
function popup_tabs(){
	...
	if(!is_numeric($EnableGroupWareScreen)){$EnableGroupWareScreen=0;}
	$page=CurrentPageName();
...
function organization_users_list(){
	...
	$html="<table style='width:100%;margin:5px'>
	<tr>
