...
$GLOBALS["CACHEFILE"]="/usr/share/artica-postfix/ressources/logs/artica.license.progress";
$GLOBALS["LOGSFILES"]="/usr/share/artica-postfix/ressources/logs/web/artica_license.txt";
...
function popup(){
	...
	$page=CurrentPageName();
	$sock=new sockets();
	$sock->getFrameWork("services.php?license-register=yes");
	$t=$_GET["t"];
