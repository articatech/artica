...
function js(){
	...
	$title=$tpl->javascript_parse_text("{smtp_generic_maps}");
...
function popup(){
	...
	$sock->getFrameWork("postfix.php?postfix-hash-smtp-generic=yes");
	$t=$_GET["t"];
	if(!is_numeric($t)){$t=time();}
	$text=$tpl->_ENGINE_parse_body("{smtp_generic_maps}");
