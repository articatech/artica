...
$GLOBALS["LOG_FILE"]="/usr/share/artica-postfix/ressources/logs/influxdb.install.progress.txt";
...
function popup(){
	...
	$sock->getFrameWork("influx.php?install-tgz=".urlencode($_GET["filename"])."&key={$_GET["key"]}");
	$t=$_GET["t"];
