...
$GLOBALS["CACHEFILE"]="/usr/share/artica-postfix/ressources/logs/web/squid.rdpproxy.progress";
...
function title(){
	...
	$tpl=new templates();
	$sock=new sockets();
	return $tpl->_ENGINE_parse_body("{APP_RDPPROXY}");
}
...
function Launch(){
	$sock=new sockets();
	$suffix=suffix();
	$cmd="rdpproxy.php?restart-progress=yes";
