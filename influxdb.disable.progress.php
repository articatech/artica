...
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/influxdb.remove.progress";
$GLOBALS["LOG_FILE"]="/usr/share/artica-postfix/ressources/logs/web/influxdb.remove.progress.txt";
...
function js(){
	...
	$title=$tpl->javascript_parse_text("{disable_service}");
...
function popup(){
	...
	$sock->getFrameWork("squid2.php?disable-influxdb=yes");
	$t=$_GET["t"];
	if(!is_numeric($t)){$t=time();}
	$text=$tpl->_ENGINE_parse_body("{disable_service}...");
