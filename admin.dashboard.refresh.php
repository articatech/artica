...
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/admin.refresh.progress";
$GLOBALS["LOG_FILE"]="/usr/share/artica-postfix/ressources/logs/admin.refresh.progress.txt";
...
function popup(){
	...
	$sock->getFrameWork("system.php?dashboard-refresh=yes");
	$t=$_GET["t"];
