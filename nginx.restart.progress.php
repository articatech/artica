...
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/nginx.restart.progress";
$GLOBALS["LOG_FILE"]="/usr/share/artica-postfix/ressources/logs/nginx.restart.progress.txt";
...
function popup(){
	...
	$sock->getFrameWork("nginx.php?restart-progress=yes");
	$t=$_GET["t"];
