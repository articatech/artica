...
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/privoxy.squid.progress";
$GLOBALS["LOG_FILE"]="/usr/share/artica-postfix/ressources/logs/privoxy.squid.progress.txt";
...
function js(){
	...
	$title=$tpl->javascript_parse_text("{APP_PRIVOXY}");
...
function popup(){
	...
	$sock->getFrameWork("privoxy.php?squid=yes");
	$t=$_GET["t"];
	if(!is_numeric($t)){$t=time();}
	$text=$tpl->_ENGINE_parse_body("{APP_PRIVOXY}...");
