...
var x_SaveAmavisPlugins=function(obj){
	...
	function SaveAmavisPlugins(){
		...
		if(document.getElementById('ArticaAmavisEnablePlugin').checked){XHR.appendData('ArticaAmavisEnablePlugin',1);}else{XHR.appendData('ArticaAmavisEnablePlugin',0);}
		if(document.getElementById('EnableClamavDaemon').checked){XHR.appendData('EnableClamavDaemon',1);}else{XHR.appendData('EnableClamavDaemon',0);}
	...
	function CheckClamavDaemon(){
		var ClamavDaemonInstalled=$ClamavDaemonInstalled;
		if(ClamavDaemonInstalled==0){
			document.getElementById('EnableClamavDaemon').disabled=true;
		}
	}
