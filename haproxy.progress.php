<?php
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/web/haproxy.progress";
...
function title(){
	$tpl=new templates();
	return $tpl->javascript_parse_text("{load_balancing}");
}
...
function Launch(){
	$sock=new sockets();
	$cmd="haproxy.php?restart=yes".suffix();
