...
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/cgroups.install.progress";
$GLOBALS["LOG_FILE"]="/usr/share/artica-postfix/ressources/logs/web/cgroups.install.progress.txt";
...
function js(){
	...
	$title=$tpl->javascript_parse_text("{install_cgroups}");
...
function popup(){
	...
	$sock->getFrameWork("cgroup.php?install=yes");
	$t=$_GET["t"];
	if(!is_numeric($t)){$t=time();}
	$text=$tpl->_ENGINE_parse_body("{install_cgroups}...");
