...
function table(){
	...
	$buttons="
	 buttons : [
	{name: '$upload', bclass: 'add', onpress : upload$t},
	{name: '$browse', bclass: 'add', onpress : xBrowseDir$t},
	{name: '$restore', bclass: 'Reconf', onpress : xrestore$t},
	{name: '$remote_server', bclass: 'Reconf', onpress : xrestore2$t},
	...
	dataType: 'json',
	colModel : [
	{display: '$backup', name : 'hostname', width : 597, sortable : true, align: 'left'},
