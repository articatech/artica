...
$GLOBALS["LOG_FILE"]="/usr/share/artica-postfix/ressources/logs/web/squid.paranoid.progress.txt";
...
function js(){
	...
	$title=$tpl->javascript_parse_text("{paranoid_mode}");
...
function popup(){
	...
	$sock->getFrameWork("squid2.php?paranoid-emergency-progress=yes");
	$t=$_GET["t"];
	if(!is_numeric($t)){$t=time();}
	$text=$tpl->_ENGINE_parse_body("{paranoid_mode}...");
