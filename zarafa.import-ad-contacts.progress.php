<?php
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/web/zarafa-import-ad-contatcs.progress";
...
function title(){
	$tpl=new templates();
	return $tpl->javascript_parse_text("{import_contacts}");
}
...
function Launch(){
	$sock=new sockets();
	$cmd="zarafa.php?ad-import-contacts=yes".suffix();
