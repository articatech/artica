...
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/UpdateUtility.install.progress";
$GLOBALS["LOG_FILE"]="/usr/share/artica-postfix/ressources/logs/web/UpdateUtility.install.progress.txt";
...
function js(){
	...
	$title=$tpl->javascript_parse_text("{UpdateUtility_installation}");
...
function popup(){
	...
	$sock->getFrameWork("updateutility.php?install=yes");
	$t=$_GET["t"];
	if(!is_numeric($t)){$t=time();}
	$text=$tpl->_ENGINE_parse_body("{UpdateUtility_installation}...");
