...
$GLOBALS["LOGSFILES"]="/usr/share/artica-postfix/ressources/logs/web/dhcpd.progress.txt";
...
function title(){
	...
	$tpl=new templates();
	$title=$tpl->_ENGINE_parse_body("{EnableDHCPServer}");
	return $title;
}
...
function Launch(){
	$sock=new sockets();
	$cmd="dhcpd.php?wizard-enable=yes";
