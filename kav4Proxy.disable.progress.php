...
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/web/kav4Proxy.enable.progress";
$GLOBALS["LOG_FILE"]="/usr/share/artica-postfix/ressources/logs/web/kav4Proxy.enable.progress.txt";
...
function js(){
	...
	$title=$tpl->javascript_parse_text("{disable} {APP_KAV4PROXY}");
	echo "
	YahooWinBrowseHide();		
...
function popup(){
	...
	$sock->getFrameWork("kav4proxy.php?unhook-local-service=yes");
	$t=$_GET["t"];
